...
export default function LineWaves({
  ...
  useEffect(() => {
    ...
    // Add missing options to suppress ogl transparent canvas warnings and maximize blending
    ...
    function handleMouseMove(e) {
      if (!gl.canvas) return;
      // We grab global mouse coordinates over the window instead of just the canvas bounding rect 
      // because our canvas will be full screen fixed layout with pointer-events: none
      targetMouse = [
    ...
    if (enableMouseInteraction) {
      // Swapped from gl.canvas locally to the whole document window for global capture
